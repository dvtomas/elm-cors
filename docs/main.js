...
var author$project$Main$MessagesList = function (a) {
	return {$: 'MessagesList', a: a};
};
...
var author$project$Main$decoderMessage = A5(
...
var author$project$Main$encodeMessagesQuery = function (query) {
	return elm$json$Json$Encode$object(_List_Nil);
};
var author$project$Main$messageApiUrl = 'https://fffuuu-c42f.restdb.io/rest/messages';
...
var author$project$Main$getMessagesCmd = function (query) {
	return elm$http$Http$request(
		{
			body: elm$http$Http$jsonBody(
				author$project$Main$encodeMessagesQuery(query)),
			expect: A2(
				elm$http$Http$expectJson,
				author$project$Main$MessagesList,
				elm$json$Json$Decode$list(author$project$Main$decoderMessage)),
			headers: _List_fromArray(
				[author$project$Main$apiKeyHeader]),
			method: 'GET',
			timeout: elm$core$Maybe$Nothing,
			tracker: elm$core$Maybe$Nothing,
			url: author$project$Main$messageApiUrl
		});
};
var author$project$Main$initialModel = {discussion: _List_Nil};
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		author$project$Main$initialModel,
		author$project$Main$getMessagesCmd(
			{}));
};
...
var author$project$Main$restDbError = F2(
	function (description, httpError) {
		return {
			message: author$project$Main$httpErrorToString(httpError),
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						discussion: A2(
							elm$core$List$cons,
							A2(author$project$Main$restDbError, 'Error while retrieving messages list', error),
							model.discussion)
					}),
				elm$core$Platform$Cmd$none);
		}
...
var author$project$Main$view = function (model) {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$text(message.username)
						])),
					elm$html$Html$text(' '),
					A2(
					elm$html$Html$i,
					...
					_List_fromArray(
						[
							...
							elm$core$String$fromInt(
								elm$time$Time$posixToMillis(message.timestamp)))
						])),
					elm$html$Html$text(' '),
					A2(
					elm$html$Html$b,
					...
					_List_fromArray(
						[
							elm$html$Html$text(message.topic)
						])),
					A2(
					elm$html$Html$p,
					_List_Nil,
	...
	var messagesList = A2(
		...
		A2(
			...
			A2(elm$core$List$map, viewMessage, model.discussion)));
	return A2(
		elm$html$Html$p,
		_List_Nil,
		_List_fromArray(
			[
				elm$html$Html$text('I\'d like the following to be a list of messages retrieved from RestDb, but actually it\'s just an CORS error message'),
				A2(elm$html$Html$br, _List_Nil, _List_Nil),
				messagesList,
				A2(elm$html$Html$br, _List_Nil, _List_Nil),
				elm$html$Html$text('The following curl expression works and retrieves the messages'),
				A2(elm$html$Html$br, _List_Nil, _List_Nil),
				A2(
				elm$html$Html$code,
				_List_Nil,
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Main.Discussion":{"args":[],"type":"List.List Main.Message"},"Main.Message":{"args":[],"type":"{ username : String.String, timestamp : Time.Posix, topic : String.String, message : String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"MessagesList":["Result.Result Http.Error Main.Discussion"]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));